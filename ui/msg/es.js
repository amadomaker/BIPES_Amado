var MSG = {
  ...
  blocks: "Bloques",
  console: "Consola",
  consoleCopyPaste: "<tt>Ctrl+Insert</tt> para copiar y <tt>Shift+Insert</tt> para pegar",
  consoleRunBlocks: "Ejecutar programa basado en bloques",
  consoleStopProgram: "Detener programa en ejecución",
  consoleSoftReset: "Reiniciar dispositivo",
  consoleRunEditedFile: "Ejecutar archivo Python editado",
  consoleClearOutput: "Limpiar salida de la consola",
  consoleBridgeData: "Enviar datos a EasyMQTT",
  consoleConfigureBridge: "Configurar puente de EasyMQTT",
  files: "Files",
  shared: "Shared",
  device: "Device",
...
//Splash screen
  ...
  // Visión / Valores continuos (F1)
  vision_when_update_title: "Cuando la cámara se actualice",
  vision_when_update_do: "hacer",
  vision_hand_pos_title: "posición de la mano eje",
  vision_axis_x: "X (horizontal)",
  vision_axis_y: "Y (vertical)",
  vision_pinch_title: "distancia de la pinza (pulgar-índice)",
  // Visión / Color (F3a)
  vision_when_color_title: "Cuando aparezca el color",
  vision_when_color_do: "hacer",
  vision_color_preset_title: "color",
  vision_color_captured_title: "color capturado n.º",
  color_red: "Rojo",
