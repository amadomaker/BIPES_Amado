var MSG = {
  ...
  blocks: "Blocos",
  console: "Console",
  consoleCopyPaste: "<tt>Ctrl+Insert</tt> para copiar e <tt>Shift+Insert</tt> para colar",
  consoleRunBlocks: "Executar programa baseado em blocos",
  consoleStopProgram: "Parar programa em execução",
  consoleSoftReset: "Reinicializar dispositivo",
  consoleRunEditedFile: "Executar arquivo Python editado",
  consoleClearOutput: "Limpar saída do terminal",
  consoleBridgeData: "Enviar dados para o EasyMQTT",
  consoleConfigureBridge: "Configurar ponte do EasyMQTT",
  files: "Arquivos",
...
//Splash screen
  ...
  vision_when_color_do: "faça",
  vision_color_preset_title: "cor",
  vision_color_captured_title: "cor capturada nº",
  color_red: "Vermelho",
