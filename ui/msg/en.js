var MSG = {
  ...
  blocks: "Blocks",
  console: "Console",
  consoleCopyPaste: "<tt>Ctrl+Insert</tt> to copy and <tt>Shift+Insert</tt> to paste",
  consoleRunBlocks: "Run block-based program",
  consoleStopProgram: "Stop running program",
  consoleSoftReset: "Soft reset device",
  consoleRunEditedFile: "Run edited Python file",
  consoleClearOutput: "Clear terminal output",
  consoleBridgeData: "Bridge data to EasyMQTT",
  consoleConfigureBridge: "Configure EasyMQTT bridge",
  files: "Files",
  shared: "Shared",
  device: "Device",
