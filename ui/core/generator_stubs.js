...
Blockly.Python["project_metadata"] = function (block) {
  var value_project_author = Blockly.Python.valueToCode(
    block,
    "project_author",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_project_iot_id = Blockly.Python.valueToCode(
    block,
    "project_iot_id",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_project_description = Blockly.Python.valueToCode(
    block,
    "project_description",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["gpio_set"] = function (block) {
  ...
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    Blockly.Python.definitions_["import_digitalio_dir"] =
      "from digitalio import DigitalInOut, Direction, Pull";
    Blockly.Python.definitions_["gpio_set" + value_pin] =
      "try:\n\tgpio" +
      value_pin2 +
      ".deinit()\nexcept:\n\tpass\ngpio" +
      value_pin2 +
      "=DigitalInOut(board.IO" +
      value_pin2 +
      ")\n" +
      "gpio" +
      value_pin2 +
    ...
    Blockly.Python.definitions_["gpio_set"] =
...
Blockly.Python["exec_python"] = function (block) {
  var value_command = Blockly.Python.valueToCode(
    block,
    "command",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["esp32_adc"] = function (block) {
  ...
  if (dropdown_attenuation == 0) atten = "ADC.ATTN_0DB";
  if (dropdown_attenuation == 1) atten = "ADC.ATTN_2_5DB";
  if (dropdown_attenuation == 2) atten = "ADC.ATTN_6DB";
  if (dropdown_attenuation == 3) atten = "ADC.ATTN_11DB";

  var w = "ADC.WIDTH_10BIT";
  if (dropdown_width__ == 0) w = "ADC.WIDTH_9BIT";
  if (dropdown_width__ == 1) w = "ADC.WIDTH_10BIT";
  if (dropdown_width__ == 2) w = "ADC.WIDTH_11BIT";
  if (dropdown_width__ == 3) w = "ADC.WIDTH_12BIT";

  var x = value_pin.replace("(", "").replace(")", "");
  //For Circuit Python
  if (UI["workspace"].selector.value == "ESP32S2") {
    Blockly.Python.definitions_["import_board"] = "import board";
    Blockly.Python.definitions_["import_analogio"] =
      "from analogio import AnalogIn";
    Blockly.Python.definitions_["analogIn" + x] =
      "try:\n\tanalogIn" +
      x +
      ".deinit()\nexcept:\n\tpass\nanalogIn" +
      x +
    ...
    Blockly.Python.definitions_["init_adc" + x] =
      "adc" +
      x +
      "=ADC(Pin(" +
      x +
...
Blockly.Python["adc"] = function (block) {
  ...
  Blockly.Python.definitions_[`init_adc_${value_pin}`] =
    "adc" + value_pin + "=ADC(" + value_pin + ")";
...
Blockly.Python["gpio_get"] = function (block) {
  ...
  var value_pullup = Blockly.Python.valueToCode(
    block,
    "pullup",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    Blockly.Python.definitions_["import_pin"] = "from machine import Pin";
    Blockly.Python.definitions_[`gpio_get_${x}`] =
      "pIn" + x + "=Pin(" + x + ", Pin.IN" + pUpDown + ")\n\n";
...
Blockly.Python["gpio_interrupt_off"] = function (block) {
  ...
  if (value_pin)
    code =
      "p" + value_pin + ".irq(trigger=0, handler=callback" + value_pin + ")\n";
...
Blockly.Python["map_value"] = function (block) {
  var value =
    ...
    "0";
  var in_min =
    Blockly.Python.valueToCode(block, "IN_MIN", Blockly.Python.ORDER_ATOMIC) ||
    "0";
  var in_max =
    Blockly.Python.valueToCode(block, "IN_MAX", Blockly.Python.ORDER_ATOMIC) ||
    "1023";
  var out_min =
    Blockly.Python.valueToCode(block, "OUT_MIN", Blockly.Python.ORDER_ATOMIC) ||
    "0";
  var out_max =
    Blockly.Python.valueToCode(block, "OUT_MAX", Blockly.Python.ORDER_ATOMIC) ||
    "255";
...
Blockly.Python["onewire_ds18x20_read_temp"] = function (block) {
  var rom = Blockly.Python.valueToCode(
    block,
    "rom",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["init_mpu6050"] = function (block) {
  var scl = Blockly.Python.valueToCode(
    block,
    "scl",
    Blockly.Python.ORDER_ATOMIC
  );
  var sda = Blockly.Python.valueToCode(
    block,
    "sda",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["init_oled"] = function (block) {
  ...
  var i2c = Blockly.Python.valueToCode(
    block,
    "i2c",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var code =
    "i2c=I2C(" + i2c + ", scl=Pin(" + scl + "), sda=Pin(" + sda + "))\n";
  code += "oled_width = 128\n";
  code += "oled_height = 64\n";
  code += "oled = ssd1306.SSD1306_I2C(oled_width, oled_height, i2c)\n";
...
Blockly.Python["fill_oled"] = function (block) {
  var v = Blockly.Python.valueToCode(
    block,
    "value",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["write_oled"] = function (block) {
  ...
  var t = Blockly.Python.valueToCode(
    block,
    "text",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["init_tank"] = function (block) {
  var Xpos = Blockly.Python.valueToCode(
    block,
    "Xpos",
    Blockly.Python.ORDER_ATOMIC
  );
  var Ypos = Blockly.Python.valueToCode(
    block,
    "Ypos",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var code =
    ...
    "," +
    Angle +
    ", oled, oled_width, oled_height, i2c)   # uses 3 variables; X position, Y position, Start Angle\n";
...
Blockly.Python["tank_move"] = function (block) {
  ...
  var value_move = Blockly.Python.valueToCode(
    block,
    "Move",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["net_get_request"] = function (block) {
  ...
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    Blockly.Python.definitions_["import_http_get"] =
...
Blockly.Python["net_post_request"] = function (block) {
  ...
  Blockly.Python.definitions_["import_urequests"] = "import urequests";
  var code =
    'urequests.post("' + value_url + '", data = "' + value_url + '")\n';
  return [code, Blockly.Python.ORDER_NONE];
};
...
Blockly.Python["net_ifconfig"] = function (block) {
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    Blockly.Python.definitions_["import_network_a"] =
...
Blockly.Python["net_ap_mode"] = function (block) {
  var value_wifi_essid = Blockly.Python.valueToCode(
    block,
    "wifi_essid",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_wifi_key = Blockly.Python.valueToCode(
    block,
    "wifi_key",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["wifi_client_connect"] = function (block) {
  var value_wifi_client_essid = Blockly.Python.valueToCode(
    block,
    "wifi_client_essid",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_wifi_client_key = Blockly.Python.valueToCode(
    block,
    "wifi_client_key",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    code +=
      "wifi.radio.connect(" +
      value_wifi_client_essid +
      "," +
      value_wifi_client_key +
      ")\n";
...
Blockly.Python["wifi_client_scan_networks"] = function (block) {
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    Blockly.Python.definitions_["import_wifi"] = "import wifi";
    Blockly.Python.definitions_["import_socketpool"] = "import socketpool";
    Blockly.Python.definitions_["import_scan_wifi"] =
      'def scan_wifi():\n\tfor network in wifi.radio.start_scanning_networks():\n\t\tprint("\t%s\t\tRSSI: %d\tChannel: %d" % (str(network.ssid, "utf-8"), network.rssi, network.channel))\n\twifi.radio.stop_scanning_networks()\n';
    var code = "scan_wifi()";
  } else {
    Blockly.Python.definitions_["import_network"] = "import network";
    Blockly.Python.definitions_["import_network_sta_init"] =
      "sta_if = network.WLAN(network.STA_IF); sta_if.active(True) \n";
...
Blockly.Python["tm1640_init"] = function (block) {
  var clk = Blockly.Python.valueToCode(
    block,
    "clk",
    Blockly.Python.ORDER_ATOMIC
  );
  var dio = Blockly.Python.valueToCode(
    block,
    "dio",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["tm1640_num"] = function (block) {
  ...
  var code =
    "digits = [0x3c66666e76663c00, 0x7e1818181c181800, 0x7e060c3060663c00, 0x3c66603860663c00, 0x30307e3234383000, 0x3c6660603e067e00, 0x3c66663e06663c00, 0x1818183030667e00, 0x3c66663c66663c00, 0x3c66607c66663c00]\ntm.write_int(digits[" +
    pIn +
    "])\n";
  return code;
};
...
Blockly.Python["tm1640_custom"] = function (block) {
  ...
  var line1 =
    Number(checkbox_a0) * 2 ** 0 +
    Number(checkbox_a1) * 2 ** 1 +
    Number(checkbox_a2) * 2 ** 2 +
    Number(checkbox_a3) * 2 ** 3 +
    Number(checkbox_a4) * 2 ** 4 +
    Number(checkbox_a5) * 2 ** 5 +
    Number(checkbox_a6) * 2 ** 6 +
    Number(checkbox_a7) * 2 ** 7;
  var line2 =
    Number(checkbox_b0) * 2 ** 0 +
    Number(checkbox_b1) * 2 ** 1 +
    Number(checkbox_b2) * 2 ** 2 +
    Number(checkbox_b3) * 2 ** 3 +
    Number(checkbox_b4) * 2 ** 4 +
    Number(checkbox_b5) * 2 ** 5 +
    Number(checkbox_b6) * 2 ** 6 +
    Number(checkbox_b7) * 2 ** 7;
  var line3 =
    Number(checkbox_c0) * 2 ** 0 +
    Number(checkbox_c1) * 2 ** 1 +
    Number(checkbox_c2) * 2 ** 2 +
    Number(checkbox_c3) * 2 ** 3 +
    Number(checkbox_c4) * 2 ** 4 +
    Number(checkbox_c5) * 2 ** 5 +
    Number(checkbox_c6) * 2 ** 6 +
    Number(checkbox_c7) * 2 ** 7;
  var line4 =
    Number(checkbox_d0) * 2 ** 0 +
    Number(checkbox_d1) * 2 ** 1 +
    Number(checkbox_d2) * 2 ** 2 +
    Number(checkbox_d3) * 2 ** 3 +
    Number(checkbox_d4) * 2 ** 4 +
    Number(checkbox_d5) * 2 ** 5 +
    Number(checkbox_d6) * 2 ** 6 +
    Number(checkbox_d7) * 2 ** 7;
  var line5 =
    Number(checkbox_e0) * 2 ** 0 +
    Number(checkbox_e1) * 2 ** 1 +
    Number(checkbox_e2) * 2 ** 2 +
    Number(checkbox_e3) * 2 ** 3 +
    Number(checkbox_e4) * 2 ** 4 +
    Number(checkbox_e5) * 2 ** 5 +
    Number(checkbox_e6) * 2 ** 6 +
    Number(checkbox_e7) * 2 ** 7;
  var line6 =
    Number(checkbox_f0) * 2 ** 0 +
    Number(checkbox_f1) * 2 ** 1 +
    Number(checkbox_f2) * 2 ** 2 +
    Number(checkbox_f3) * 2 ** 3 +
    Number(checkbox_f4) * 2 ** 4 +
    Number(checkbox_f5) * 2 ** 5 +
    Number(checkbox_f6) * 2 ** 6 +
    Number(checkbox_f7) * 2 ** 7;
  var line7 =
    Number(checkbox_g0) * 2 ** 0 +
    Number(checkbox_g1) * 2 ** 1 +
    Number(checkbox_g2) * 2 ** 2 +
    Number(checkbox_g3) * 2 ** 3 +
    Number(checkbox_g4) * 2 ** 4 +
    Number(checkbox_g5) * 2 ** 5 +
    Number(checkbox_g6) * 2 ** 6 +
    Number(checkbox_g7) * 2 ** 7;
  var line8 =
    Number(checkbox_h0) * 2 ** 0 +
    Number(checkbox_h1) * 2 ** 1 +
    Number(checkbox_h2) * 2 ** 2 +
    Number(checkbox_h3) * 2 ** 3 +
    Number(checkbox_h4) * 2 ** 4 +
    Number(checkbox_h5) * 2 ** 5 +
    Number(checkbox_h6) * 2 ** 6 +
    Number(checkbox_h7) * 2 ** 7;
...
Blockly.Python["easymqtt_publish_data"] = function (block) {
  var topic = Blockly.Python.valueToCode(
    block,
    "topic",
    Blockly.Python.ORDER_ATOMIC
  );
  var data = Blockly.Python.valueToCode(
    block,
    "data",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var code =
    'easymqtt_client.publish(easymqtt_session + "/" + ' +
    topic +
    ", str(" +
    data +
    '))\nprint("EasyMQTT Publish - Session:",easymqtt_session,"Topic:",' +
    topic +
    ',"Value:",str(' +
    data +
    "))\n";
...
Blockly.Python["easymqtt_subscribe"] = function (block) {
  var var_name = Blockly.Python.nameDB_.getName(
    block.getFieldValue("EASYMQTT_VAR"),
  ...
  for (var i = 0; i < devVarList.length; i++) {
    globals.push(
      Blockly.Python.nameDB_.getName(
        devVarList[i],
  ...
  var function_name = Blockly.Python.provideFunction_("easymqtt" + name, [
    "def " + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + "(" + var_name + "):",
    globals,
    funct_code,
  ]);

  Blockly.Python.definitions_["easymqtt_callback"] =
    "easymqtt_callback_list = {}\ndef easymqtt_callback(topic_,msg_):\n  topic_=topic_.decode();msg_=msg_.decode()\n  if topic_ in easymqtt_callback_list: easymqtt_callback_list[topic_](float(msg_))";

  var code =
    "easymqtt_client.set_callback(easymqtt_callback)\neasymqtt_callback_list['" +
    window.easyMQTT_session +
    "/' + " +
    topic +
    "]=" +
    function_name +
    "\neasymqtt_client.subscribe('" +
    window.easyMQTT_session +
    "/' + " +
    topic +
    ")\n";
...
Blockly.Python["mqtt_init"] = function (block) {
  var server = Blockly.Python.valueToCode(
    block,
    "server",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var user = Blockly.Python.valueToCode(
    block,
    "user",
    Blockly.Python.ORDER_ATOMIC
  );
  var pass = Blockly.Python.valueToCode(
    block,
    "password",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["mqtt_publish_payload"] = function (block) {
  ...
  var payload = Blockly.Python.valueToCode(
    block,
    "payload",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["mqtt_set_callback"] = function (block) {
  var data_var_name = Blockly.Python.nameDB_.getName(
    block.getFieldValue("MQTT_DATA_VAR"),
    Blockly.VARIABLE_CATEGORY_NAME
  );
  var topic_var_name = Blockly.Python.nameDB_.getName(
    block.getFieldValue("MQTT_TOPIC_VAR"),
    Blockly.VARIABLE_CATEGORY_NAME
  );
  // Fix for global variables inside callback
  // Piece of code from generators/python/procedures.js
  ...
  for (var i = 0, variable; (variable = variables[i]); i++) {
    varName = variable.name;
    if (
      block.getVars().indexOf(varName) == -1 &&
      varName != data_var_name &&
  ...
  var function_name = Blockly.Python.provideFunction_("mqtt_callback", [
    "def " +
...
Blockly.Python["machine.ADCWiPy_ADCWiPy.init"] = function (block) {
  Blockly.Python.definitions_["import_machine.ADCWiPy"] =
    "import machine.ADCWiPy";
...
Blockly.Python["machine.Signal_Signal.on"] = function (block) {
  Blockly.Python.definitions_["import_machine.Signal"] =
    "import machine.Signal";
...
Blockly.Python["machine.TimerWiPy_TimerWiPy.deinit"] = function (block) {
  Blockly.Python.definitions_["import_machine.TimerWiPy"] =
    "import machine.TimerWiPy";
...
Blockly.Python["ubluetooth_BLE.gattc_discover_characteristics"] = function (
  block
) {
  var value_pIn = Blockly.Python.valueToCode(
    block,
  ...
  var code =
    "ubluetooth.BLE.gattc_discover_characteristics(" + value_pIn + ")\n";
  return code;
};
...
Blockly.Blocks["tostr"] = {
  init: function () {
    this.setColour(65);
    this.appendValueInput("input").appendField("to String");
    this.setOutput(true, "String");
    this.setTooltip("");
  },
};
Blockly.Python["tostr"] = function (block) {
  var input = Blockly.Python.valueToCode(
    block,
    "input",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Blocks["copy"] = {
  init: function () {
    this.setColour(45);
    this.appendValueInput("image").setCheck("image").appendField("copy");
...
Blockly.Blocks["convertTo"] = {
  init: function () {
    this.setColour(45);
    this.appendValueInput("input").setCheck("image").appendField("convertTo");
...
Blockly.Blocks["roi"] = {
  init: function () {
    this.setColour(45);
    this.appendValueInput("input").setCheck("image");
...
Blockly.Python["roi"] = function (block) {
  ...
  var code =
    input + "[int(" + y0 + "):int(" + y1 + "),int(" + x0 + "):int(" + x1 + ")]";
  return [code, Blockly.Python.ORDER_NONE];
};
...
Blockly.Blocks["indexed"] = {
  init: function () {
    this.setColour(45);
    this.appendDummyInput().appendField("indexed");
    this.appendValueInput("input").setCheck("image");
...
Blockly.Blocks["imgsize"] = {
  init: function () {
    this.setColour(45);
    this.appendDummyInput().appendField("imgsize");
...
Blockly.Blocks["load"] = {
  ...
  getVars: function () {
    return [this.getFieldValue("image")];
  },
  renameVar: function (oldName, newName) {
    if (Blockly.Names.equals(oldName, this.getFieldValue("image"))) {
      this.setFieldValue(newName, "image");
    }
  },
};
...
Blockly.Blocks["waitkey"] = {
  init: function () {
    this.setColour(45);
    this.setInputsInline(true);
    this.appendDummyInput().appendField("waitKey");
    this.appendDummyInput()
      .appendField("millis")
...
Blockly.Blocks["onmouse"] = {
  ...
  renameVar: function (oldName, newName) {
    if (Blockly.Names.equals(oldName, this.getFieldValue("windowname"))) {
      this.setFieldValue(newName, "windowname");
    }
    if (Blockly.Names.equals(oldName, this.getFieldValue("button"))) {
      this.setFieldValue(newName, "button");
    }
    ...
    if (Blockly.Names.equals(oldName, this.getFieldValue("state"))) {
      this.setFieldValue(newName, "state");
    }
  },
};
...
Blockly.Python["cascade"] = function (block) {
  ...
  var code =
    ...
    "if " +
    cascade +
    '.empty(): raise Exception("your cascade is empty. are you sure, the path is correct ?")\n';
  return code;
};
...
Blockly.Blocks["findobjects"] = {
  init: function () {
    ...
    this.setOutput(true);
    this.setTooltip(
      "find objects in an image and return a list of rects.\nto draw them, you will need the tl and br items"
    );
  },
  getVars: function () {
    return [this.getFieldValue("cascade")];
...
Blockly.Blocks["videocapture"] = {
  init: function () {
    ...
    this.appendStatementInput("statements").setCheck("image");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
  },
...
Blockly.Python["videocapture"] = function (block) {
  ...
  var code =
    ...
    text_input +
    ")\n" +
    'if not cap.isOpened(): raise Exception("your input:' +
    text_input +
    ' could not be opened !")\n' +
    "while cap.isOpened():\n  r," +
    img_name +
...
Blockly.Blocks["VideoWriter_write"] = {
  init: function () {
    ...
    this.appendDummyInput()
      .appendField("write")
      .appendField(new Blockly.FieldVariable("writer"), "writer");
    this.appendValueInput("image").appendField("image").setCheck("image");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Python["VideoWriter_VideoWriter"] = function (block) {
  ...
  var frameSize = Blockly.Python.valueToCode(
    block,
    "frameSize",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  code +=
    "if not " +
    writer +
    '.isOpened(): raise Exception("your writer failed to open!")\n';
  return code;
};
...
Blockly.Blocks["cvtcolor"] = {
  init: function () {
    ...
    this.appendValueInput("img").setCheck("image").appendField("cvtColor");
    this.setOutput(true, "image");
    this.setTooltip("");
  },
};
...
Blockly.Blocks["threshold"] = {
  init: function () {
    ...
    this.appendValueInput("img").appendField("threshold").setCheck("image");
    this.setOutput(true, "image");
    this.setTooltip("");
  },
};
...
Blockly.Python["newimage"] = function (block) {
  ...
  var c = Blockly.Python.valueToCode(
    block,
    "color",
    Blockly.Python.ORDER_ATOMIC
  );
  code = "np.ones((" + h + "," + w + "),np.uint8)";
  if (t == "bgr") code = "np.ones((" + h + "," + w + "," + 3 + "),np.uint8)";
  if (t == "float") code = "np.ones((" + h + "," + w + "),np.float)";
  if (c) code += " * " + c;
  return [code, Blockly.Python.ORDER_NONE];
};
...
Blockly.Blocks["point_tl"] = {
  init: function () {
    this.setColour(65);
    this.appendValueInput("rect").appendField("tl").setCheck("rect");
    this.setOutput(true, "point");
    this.setTooltip("");
  },
};
Blockly.Python["point_tl"] = function (block) {
  var r = Blockly.Python.valueToCode(
    block,
    "rect",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Blocks["point_br"] = {
  init: function () {
    this.setColour(65);
    this.appendValueInput("rect").appendField("br").setCheck("rect");
    this.setOutput(true, "point");
    this.setTooltip("");
  },
};
...
Blockly.Blocks["forRange"] = {
  init: function () {
    ...
    this.appendValueInput("rend").setCheck("Number");
    this.appendStatementInput("statement");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Python["forRange"] = function (block) {
  ...
  var stop = Blockly.Python.valueToCode(
    block,
    "rend",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Blocks["forEnum"] = {
  init: function () {
    this.setColour(135);
    this.setInputsInline(true);
    this.appendDummyInput().appendField("enumerate");
    this.appendDummyInput()
  ...
  renameVar: function (oldName, newName) {
    if (Blockly.Names.equals(oldName, this.getFieldValue("index"))) {
      this.setFieldValue(newName, "index");
    }
    if (Blockly.Names.equals(oldName, this.getFieldValue("i"))) {
      this.setFieldValue(newName, "i");
    }
  },
};
...
Blockly.Python["utime.ticks_add"] = function (block) {
  Blockly.Python.definitions_["import_utime"] = "import utime";
  var value_time1 = Blockly.Python.valueToCode(
    block,
    "TIME1",
    Blockly.Python.ORDER_NONE
  );
  var value_time2 = Blockly.Python.valueToCode(
    block,
    "TIME2",
    Blockly.Python.ORDER_NONE
  );
...
Blockly.Python["esp32_set_rtc"] = function (block) {
  ...
  var y = Blockly.Python.valueToCode(
    block,
    "year",
    Blockly.Python.ORDER_ATOMIC
  );
  var m = Blockly.Python.valueToCode(
    block,
    "month",
    Blockly.Python.ORDER_ATOMIC
  );
  var d = Blockly.Python.valueToCode(block, "day", Blockly.Python.ORDER_ATOMIC);
  var h = Blockly.Python.valueToCode(
    block,
    "hour",
    Blockly.Python.ORDER_ATOMIC
  );
  var min = Blockly.Python.valueToCode(
    block,
    "minute",
    Blockly.Python.ORDER_ATOMIC
  );
  var s = Blockly.Python.valueToCode(
    block,
    "second",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["stop_timer"] = function (block) {
  ...
  var tn = Blockly.Python.valueToCode(
    block,
    "timerNumber",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["iniciar_thread"] = function (block) {
  ...
  var function_name = Blockly.Python.valueToCode(
    block,
    "FUNCTION",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["timer"] = function (block) {
  ...
  Blockly.Python.definitions_["import_timer"] = "from machine import Timer";
  Blockly.Python.definitions_[
    `import_timer_start${timerNumber}`
  ] = `tim${timerNumber} = Timer(${timerNumber})`;

  Blockly.Python.definitions_[
    `import_timer_callback${timerNumber}`
...
Blockly.Python["pico_timer"] = function (block) {
  ...
  var code =
    "tim.init(period=" +
    interval +
    ", mode=Timer.PERIODIC, callback=timerFunc)\n";

  return code;
};

Blockly.Python["deep_sleep8266"] = function (block) {
  var value_interval = Blockly.Python.valueToCode(
    block,
    "interval",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["pwm"] = function (block) {
  ...
  var value_frequency = Blockly.Python.valueToCode(
    block,
    "frequency",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_duty = Blockly.Python.valueToCode(
    block,
    "duty",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["randomforestclassifier"] = function (block) {
  var value_random_state = Blockly.Python.valueToCode(
    block,
    "random_state",
    Blockly.Python.ORDER_ATOMIC
  );
  Blockly.Python.definitions_["import_random_forest_classifier"] =
    "from sklearn.ensemble import RandomForestClassifier";
  var code =
    "RandomForestClassifier(random_state=" + value_random_state + ")\n";
  return [code, Blockly.Python.ORDER_NONE];
};

Blockly.Python["fit"] = function (block) {
  var value_classifier = Blockly.Python.valueToCode(
    block,
    "classifier",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["file_close"] = function (block) {
  var variable_filename = Blockly.Python.nameDB_.getName(
    block.getFieldValue("filename"),
    Blockly.VARIABLE_CATEGORY_NAME
  );
...
Blockly.Python["file_write_byte"] = function (block) {
  ...
  var code =
    variable_filename + '.write(struct.pack("B",' + value_data + "))\n";
...
Blockly.Python["hcsr_init"] = function (block) {
  var pEcho = Blockly.Python.valueToCode(
    block,
    "echo",
    Blockly.Python.ORDER_ATOMIC
  );
  var pTrig = Blockly.Python.valueToCode(
    block,
    "trigger",
    Blockly.Python.ORDER_ATOMIC
  );
  var pTime = Blockly.Python.valueToCode(
    block,
    "timeout",
    Blockly.Python.ORDER_ATOMIC
  );
...
*/
  ...
  var code =
    "ultraSoundSensor = HCSR04(trigger_pin=" +
    pTrig +
    ", echo_pin=" +
    pEcho +
    ", echo_timeout_us=" +
...
Blockly.Python["char_lcd_init"] = function (block) {
  Blockly.Python.definitions_["import_i2c_lcd"] =
...
Blockly.Python["rfid_rc522_init"] = function (block) {
  var sck = Blockly.Python.valueToCode(
    block,
    "sck",
    Blockly.Python.ORDER_ATOMIC
  );
  var mosi = Blockly.Python.valueToCode(
    block,
    "mosi",
    Blockly.Python.ORDER_ATOMIC
  );
  var miso = Blockly.Python.valueToCode(
    block,
    "miso",
    Blockly.Python.ORDER_ATOMIC
  );
  var rst = Blockly.Python.valueToCode(
    block,
    "rst",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["rfid_rc522_detect_card"] = function (block) {
  var stat = Blockly.Python.valueToCode(
    block,
    "stat",
    Blockly.Python.ORDER_ATOMIC
  );
  var tag = Blockly.Python.valueToCode(
    block,
    "tag",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["umail_init"] = function (block) {
  var host = Blockly.Python.valueToCode(
    block,
    "host",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var username = Blockly.Python.valueToCode(
    block,
    "username",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["umail_send"] = function (block) {
  ...
  var subject = Blockly.Python.valueToCode(
    block,
    "subject",
    Blockly.Python.ORDER_ATOMIC
  );
  var contents = Blockly.Python.valueToCode(
    block,
    "contents",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["net_wiznet5k_init"] = function (block) {
  ...
  var spi = Blockly.Python.valueToCode(
    block,
    "spi",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["net_wiznet5k_ifconfig"] = function (block) {
  ...
  var subnet = Blockly.Python.valueToCode(
    block,
    "subnet",
    Blockly.Python.ORDER_ATOMIC
  );
  var gw = Blockly.Python.valueToCode(block, "gw", Blockly.Python.ORDER_ATOMIC);
  var dns = Blockly.Python.valueToCode(
    block,
    "dns",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["net_socket_receive"] = function (block) {
  var bytes = Blockly.Python.valueToCode(
    block,
    "bytes",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["net_http_server_start"] = function (block) {
  ...
  if (UI["workspace"].selector.value == "ESP32S2") {
    ...
    var code =
      "http_addr = socket.getaddrinfo('0.0.0.0'," + port + ")[0][-1]\n";
    code += "s = socket.socket()\n";
...
Blockly.Python["net_http_server_send_response"] = function (block) {
  var html = Blockly.Python.valueToCode(
    block,
    "html",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["gsm_modem_init"] = function (block) {
  ...
  var bps = Blockly.Python.valueToCode(
    block,
    "bps",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["gsm_modem_send_at"] = function (block) {
  var cmd = Blockly.Python.valueToCode(
    block,
    "cmd",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["gsm_modem_send_sms"] = function (block) {
  var dst = Blockly.Python.valueToCode(
    block,
    "dst",
    Blockly.Python.ORDER_ATOMIC
  );
  var msg = Blockly.Python.valueToCode(
    block,
    "msg",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["gsm_modem_response"] = function (block) {
  var timeout = Blockly.Python.valueToCode(
    block,
    "timeout",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["uart_init"] = function (block) {
  ...
  var bits = Blockly.Python.valueToCode(
    block,
    "bits",
    Blockly.Python.ORDER_ATOMIC
  );
  var par = Blockly.Python.valueToCode(
    block,
    "par",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["uart_write"] = function (block) {
  var buf = Blockly.Python.valueToCode(
    block,
    "buf",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["stepper_step"] = function (block) {
  var step = Blockly.Python.valueToCode(
    block,
    "steps",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["dc_motor_init"] = function (block) {
  ...
  var pwm = Blockly.Python.valueToCode(
    block,
    "pwm",
    Blockly.Python.ORDER_ATOMIC
  );
  var dir1 = Blockly.Python.valueToCode(
    block,
    "dir1",
    Blockly.Python.ORDER_ATOMIC
  );
  var dir2 = Blockly.Python.valueToCode(
    block,
    "dir2",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["dc_motor_power"] = function (block) {
  var motor_name = block.getFieldValue("motor_name"); // Nome do motor
  var pwr = Blockly.Python.valueToCode(
    block,
    "power",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["dc_motor_direction"] = function (block) {
  var motor_name = block.getFieldValue("motor_name"); // Nome do motor
  var dir = Blockly.Python.valueToCode(
    block,
    "dir",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["esp32_can_init"] = function (block) {
  var mode = Blockly.Python.valueToCode(
    block,
    "mode",
    Blockly.Python.ORDER_ATOMIC
  );
  var baudrate = Blockly.Python.valueToCode(
    block,
    "baudrate",
    Blockly.Python.ORDER_ATOMIC
  );
  var extframe = Blockly.Python.valueToCode(
    block,
    "extframe",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["esp32_can_filter"] = function (block) {
  var filter = Blockly.Python.valueToCode(
    block,
    "filter",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["neopixel_color_numbers"] = function (block) {
  var value_red = Blockly.Python.valueToCode(
    block,
    "red",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_green = Blockly.Python.valueToCode(
    block,
    "green",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_blue = Blockly.Python.valueToCode(
    block,
    "blue",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["HSL_to_RGB"] = function (block) {
  var value_hue = Blockly.Python.valueToCode(
    block,
    "hue",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_saturation = Blockly.Python.valueToCode(
    block,
    "saturation",
    Blockly.Python.ORDER_ATOMIC
  );
  var value_brightness = Blockly.Python.valueToCode(
    block,
    "lightness",
    Blockly.Python.ORDER_ATOMIC
  );

  Blockly.Python.definitions_["HSL_to_RGB"] =
...
Blockly.Python["neopixel_control_CPY"] = function (block) {
  ...
  Blockly.Python.definitions_["import_board"] = "import board";
  Blockly.Python.definitions_["import_neopixel_write"] =
    "import neopixel_write";
  Blockly.Python.definitions_["import_digitalio"] = "import digitalio";
  Blockly.Python.definitions_["import_neopixel_init"] =
...
Blockly.Python["neopixel_control"] = function (block) {
  var value_address = Blockly.Python.valueToCode(
    block,
    "address",
    Blockly.Python.ORDER_NONE
  );
...
Blockly.Python["bipes_plot"] = function (block) {
  var x =
    Blockly.Python.valueToCode(block, "values", Blockly.Python.ORDER_NONE) ||
    "''";
  var id =
    Blockly.Python.valueToCode(block, "id", Blockly.Python.ORDER_NONE) || "''";
...
Blockly.Python["st7789_init"] = function (block) {
  ...
  var reset = Blockly.Python.valueToCode(
    block,
    "reset",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  Blockly.Python.definitions_["import_st7789bl1"] =
    "st7789_bl = machine.Pin(" + bl + ", machine.Pin.OUT)";
  Blockly.Python.definitions_["import_st7789bl2"] =
  ...
  code +=
    "spi = machine.SPI(" +
    spi +
    ", baudrate=20000000, polarity=1, phase=1, sck=machine.Pin(" +
    sck +
    "), mosi=machine.Pin(" +
    mosi +
    "))\n";
  code +=
    "display7789 = st7789py.ST7789(spi, 135, 240, reset=machine.Pin(" +
    reset +
    ", machine.Pin.OUT), cs=machine.Pin(" +
    cs +
    ", machine.Pin.OUT), dc=machine.Pin(" +
    dc +
    ", machine.Pin.OUT))\n";
...
Blockly.Python["st7789_fill"] = function (block) {
  ...
  var code =
    "display7789.fill(st7789py.color565(" + r + ", " + g + ", " + b + "))\n";
  return code;
};
...
Blockly.Python["st7789_pixel"] = function (block) {
  ...
  var code =
    "display7789.pixel(" + x + ", " + y + ", st7789py.color565" + c + ")\n";
  return code;
};
...
Blockly.Python["control_pid.__init__"] = function (block) {
  ...
  number_sample_time =
    parseInt(number_sample_time) == 0 ? "None" : number_sample_time;
  var dropdown_scale = block.getFieldValue("SCALE");
  var value_setpoint = Blockly.Python.valueToCode(
    block,
    "SETPOINT",
    Blockly.Python.ORDER_NONE
  );
  ...
  code =
    number_sample_time != 0
      ? `${code}, sample_time=${number_sample_time})\n`
      : `${code})\n`;
  return code;
};
...
Blockly.Python["control_pid.compute"] = function (block) {
  var number_id = block.getFieldValue("ID");
  var value_input = Blockly.Python.valueToCode(
    block,
    "INPUT",
    Blockly.Python.ORDER_NONE
  );
...
Blockly.Python["control_pid.compute_not_realtime"] = function (block) {
  ...
  var value_dt = Blockly.Python.valueToCode(
    block,
    "DT",
    Blockly.Python.ORDER_NONE
  );
  ...
  return [
    `pid${number_id}(${value_input},${value_dt})`,
    Blockly.Python.ORDER_NONE,
  ];
};
...
Blockly.Python["control_pid.tunings"] = function (block) {
  var number_id = block.getFieldValue("ID");
  var value_kp = Blockly.Python.valueToCode(
    block,
    "KP",
    Blockly.Python.ORDER_NONE
  );
  var value_ki = Blockly.Python.valueToCode(
    block,
    "KI",
    Blockly.Python.ORDER_NONE
  );
  var value_kd = Blockly.Python.valueToCode(
    block,
    "KD",
    Blockly.Python.ORDER_NONE
  );
...
Blockly.Python["control_pid.auto_mode"] = function (block) {
  var number_id = block.getFieldValue("ID");
  var checkbox_enable =
    block.getFieldValue("ENABLE") == "TRUE" ? "True" : "False";
...
Blockly.Python["simulate_water_boiler"] = function (block) {
  ...
  var value_power = Blockly.Python.valueToCode(
    block,
    "POWER",
    Blockly.Python.ORDER_NONE
  );
  ...
  Blockly.Python.definitions_["import_utime"] = "import utime";
  Blockly.Python.definitions_["simulate_water_boiler_class"] =
    UPythonClass.WaterBoiler;
  Blockly.Python.definitions_[
    `simulate_water_boiler_obj${number_id}`
  ] = `water_boiler${number_id} = WaterBoiler(${number_dissipation})`;
...
Blockly.Python["simulate_dcmotor.sim"] = function (block) {
  ...
  var value_load = Blockly.Python.valueToCode(
    block,
    "LOAD",
    Blockly.Python.ORDER_NONE
  );
  ...
  Blockly.Python.definitions_[
    `simulate_dcmotor_obj${number_id}`
  ] = `dcmotor${number_id} = DCMotor(${Ra},${La},${B},${J},${Kbemf},${Static_Friction},0)`;
...
Blockly.Python["rtttl_play"] = function (block) {
  ...
  var song = Blockly.Python.valueToCode(
    block,
    "song",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var code =
    "play = rtttl.play(Pin(" + pin + ", Pin.OUT), songs.find(" + song + ")) \n";
  return code;
};
...
Blockly.Python["tone"] = function (block) {
  ...
  var d = Blockly.Python.valueToCode(
    block,
    "duration",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["snek_setpower"] = function (block) {
  ...
  if (value_duty > 1) value_duty = 1;
  if (value_duty < 0) value_duty = 0;
...
Blockly.Python["snek_gpio_set"] = function (block) {
  ...
  var code = "talkto(" + x + ")\n";
  if (value == "True") code += "on()\n";
  if (value == "False") code += "off()\n";
...
Blockly.Python["google_spreadsheet"] = function (block) {
  ...
  var value_deploy_code = Blockly.Python.valueToCode(
    block,
    "deploy_code",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  Blockly.Python.definitions_["post_data"] =
  ...
  if (cells_blocks) var num_cell = 0;
  var row_data_def = "";
  do {
...
Blockly.Python["pluvio_init"] = function (block) {
  ...
  var value_handler = Blockly.Python.valueToCode(
    block,
    "Função",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var code =
    "pluviometro=machine.Pin(" +
    value_pin +
    ",machine.Pin.IN,machine.Pin.PULL_UP) \npluviometro.irq(trigger=machine.Pin.IRQ_FALLING,handler=" +
    value_handler.replace("'", "").replace("'", "") +
    ")\n";
...
Blockly.Python["pluvio_stop"] = function (block) {
  ...
  var code =
    "pluviometro.irq(trigger=0,handler=" +
    value_handler.replace("'", "").replace("'", "") +
    ")\n";
  return code;
};
...
Blockly.Python["anemo_init"] = function (block) {
  ...
  var code =
    "anemometro=machine.Pin(" +
    value_pin +
    ",machine.Pin.IN,machine.Pin.PULL_UP) \nanemometro.irq(trigger=machine.Pin.IRQ_FALLING,handler=" +
    value_handler.replace("'", "").replace("'", "") +
    ")\n";
...
Blockly.Python["anemo_stop"] = function (block) {
  ...
  var code =
    "anemometro.irq(trigger=0,handler=" +
    value_handler.replace("'", "").replace("'", "") +
    ")\n";
  return code;
};
...
Blockly.Python["inter_init"] = function (block) {
  ...
  var value_nome = Blockly.Python.valueToCode(
    block,
    "Nome",
    Blockly.Python.ORDER_ATOMIC
  );
  ...
  var code =
    "" +
    value_nome.replace("'", "").replace("'", "") +
    "=machine.Pin(" +
    value_pin +
    ", machine.Pin.IN, machine.Pin.PULL_UP) \n" +
    value_nome.replace("'", "").replace("'", "") +
    ".irq(trigger=machine.Pin.IRQ_FALLING, handler=" +
    value_handler.replace("'", "").replace("'", "") +
    ")\n";
  return code;
};
...
Blockly.Python["try_catch"] = function (block) {
  ...
  var statements_catch_code = Blockly.Python.statementToCode(
    block,
    "catch_code"
  );
  // TODO: Assemble Python into code variable.
...
Blockly.Python["http_get_status"] = function (block) {
  var variable_request = Blockly.Python.nameDB_.getName(
    block.getFieldValue("request"),
    Blockly.VARIABLE_CATEGORY_NAME
  );
...
Blockly.Python["handle_ble_data"] = function (block) {
  var variable = Blockly.Python.valueToCode(
    ...
    "VAR",
    Blockly.Python.ORDER_ATOMIC
  ); // Obtém a variável selecionada pelo usuário
  var code =
    `def handle_ble_data():\n` +
...
Blockly.Python["configure_data_plotter"] = function (block) {
  ...
  for (var i = 0; i < sensorCount; i++) {
    var sensor = Blockly.Python.valueToCode(
      block,
      "SENSOR_" + i,
      Blockly.Python.ORDER_ATOMIC
    );
...
Blockly.Python["add_peer"] = function (block) {
  var mac_variable = Blockly.Python.valueToCode(
    block,
    "MAC",
    Blockly.Python.ORDER_ATOMIC
  ); // Captura o MAC
  var peer_name = Blockly.Python.valueToCode(
    block,
    "NAME",
    Blockly.Python.ORDER_ATOMIC
  ); // Captura o nome/identificador da placa
...
Blockly.Python["set_peer"] = function (block) {
  var mac_master = Blockly.Python.valueToCode(
    block,
    "MAC",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["send_message_to_peer"] = function (block) {
  var peer_mac_code =
    Blockly.Python.valueToCode(block, "MAC", Blockly.Python.ORDER_ATOMIC) ||
    "'None'";
  var variable_name_code =
    Blockly.Python.valueToCode(
      block,
      "VAR_NAME",
      Blockly.Python.ORDER_ATOMIC
    ) || "'None'";
  var variable_value_code =
    Blockly.Python.valueToCode(
      block,
      "VAR_VALUE",
      Blockly.Python.ORDER_ATOMIC
...
Blockly.Python["check_and_assign_value"] = function (block) {
  var variable_to_check = Blockly.Python.valueToCode(
    block,
    "VAR",
    Blockly.Python.ORDER_ATOMIC
  );
  var default_value = Blockly.Python.valueToCode(
    block,
    "DEFAULT",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["new_math_random_int"] = function (block) {
  ...
  const fromValue =
    Blockly.Python.valueToCode(block, "FROM", Blockly.Python.ORDER_ATOMIC) ||
    "1";
  const toValue =
    Blockly.Python.valueToCode(block, "TO", Blockly.Python.ORDER_ATOMIC) ||
    "100";
...
Blockly.Python["create_list_with_repeated"] = function (block) {
  const item =
    ...
    "None";
  const num =
    Blockly.Python.valueToCode(block, "NUM", Blockly.Python.ORDER_NONE) || "0";
  const code = `[${item}] * ${num}`;
  return [code, Blockly.Python.ORDER_ATOMIC];
};
