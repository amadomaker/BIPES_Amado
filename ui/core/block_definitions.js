...
//Novos blocos para o arduino
//Sensor ultrassônico
// Definição do bloco de inicialização do sensor ultrassônico para Snek
Blockly.Blocks['snek_hcsr_init'] = {
  init: function() {
    this.appendDummyInput()
    ...
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip("Initialize the HCSR04 sensor for Snek.");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};

// Definição do bloco de leitura do sensor ultrassônico para Snek
Blockly.Blocks['snek_hcsr_read'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Get distance (ultrasound sensor)");
    this.setOutput(true, "Number");
    this.setColour(230);
    this.setTooltip("Read distance from HCSR04 sensor.");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};

//ServoMotor
Blockly.Blocks['snek_servo_init'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage(
          "media/servo.png",
          ...
          55,
          "*"))
        .appendField("Initialize RC Servo Motor");
    ...
    this.appendValueInput("angle")
        .setCheck("Number")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("Initial Angle");

    this.setColour(230);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);

    this.setTooltip("Initialize servo motor with pin and initial angle.");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};
  ...
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage(
          ...
          55,
          "*"))
        .appendField("Move RC Servo Motor");

    this.appendValueInput("angle")
        .setCheck("Number")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("Target Angle");

    this.setColour(230);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);

    this.setTooltip("Move servo motor to the specified angle.");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};
