...
let BigSoundSensorElement = class BigSoundSensorElement extends lit_1.LitElement {
    ...
    render() {
      ...
      >
        ...
        ${led2 && (0, lit_1.svg) `<circle cx="56" cy="4" r="5" fill="#80ff80" filter="url(#ledFilter)" />`}
        ...
        ${led1 && (0, lit_1.svg) `<circle cx="56" cy="47" r="5" fill="#80ff80" filter="url(#ledFilter)" />`}
...
exports.BigSoundSensorElement = BigSoundSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-big-sound-sensor')
