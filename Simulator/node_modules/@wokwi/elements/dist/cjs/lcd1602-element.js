        ...
        switch (this.pins) {
            case 'i2c':
                return [
                    ...
                    { name: 'SDA', x: 4, y: 51, number: 3, signals: [(0, pin_1.i2c)('SDA')] },
                    { name: 'SCL', x: 4, y: 60.5, number: 4, signals: [(0, pin_1.i2c)('SCL')] },
                ];
            case 'full':
            default:
                return [
    ...
    renderCursor() {
      ...
      `);
        ...
        if (cursor) {
            ...
            result.push((0, lit_1.svg) `<rect x="${xOffset}" y="${y}" width="2.95" height="0.65" fill="${color}" />`);
        }
        return result;
    }
    renderI2CPins() {
...
exports.LCD1602Element = LCD1602Element = __decorate([
    (0, decorators_js_1.customElement)('wokwi-lcd1602')
], LCD1602Element);
