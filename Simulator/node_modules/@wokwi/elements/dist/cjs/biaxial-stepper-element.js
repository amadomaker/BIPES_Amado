...
exports.BiaxialStepperElement = void 0;
...
let BiaxialStepperElement = class BiaxialStepperElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
    ...
    get pinInfo() {
        const pinXY = (y) => {
            return { x: 45, y: (28.9 + y * 2.54) * units_1.mmToPix };
        };
        return [
    ...
    >
      ...
      <g transform="translate(45 30)">
        ...
        <g transform="scale(${units_1.mmToPix}) translate(2 20.5) ">
...
exports.BiaxialStepperElement = BiaxialStepperElement;
__decorate([
...
exports.BiaxialStepperElement = BiaxialStepperElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-biaxial-stepper')
