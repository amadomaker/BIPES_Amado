...
let GasSensorElement = class GasSensorElement extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'GND', y: 36.5, x: 137, number: 3, signals: [(0, pin_1.GND)()] },
            { name: 'VCC', y: 46.2, x: 137, number: 4, signals: [(0, pin_1.VCC)()] },
        ];
    }
    render() {
      ...
      >
        ...
        />
        ${ledPower &&
            (0, lit_1.svg) `<circle cx="85.5" cy="8" r="1.8" fill="#03f704" filter="url(#ledFilter)" />`}
        <rect
        ...
        <rect
          ...
          y="48.700188"
        />
        ${ledD0 && (0, lit_1.svg) `<circle cx="85" cy="50" r="1.8" fill="#03f704" filter="url(#ledFilter)" />`}
...
exports.GasSensorElement = GasSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-gas-sensor')
], GasSensorElement);
