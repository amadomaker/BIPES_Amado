...
let SmallSoundSensorElement = class SmallSoundSensorElement extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'GND', y: 20.5, x: 0, number: 2, signals: [(0, pin_1.GND)()] },
            { name: 'VCC', y: 30.5, x: 0, number: 3, signals: [(0, pin_1.VCC)()] },
    ...
    render() {
      ...
      >
        ...
        ${ledPower && (0, lit_1.svg) `<circle cx="56" cy="4" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
        ...
        ${ledSignal &&
            (0, lit_1.svg) `<circle cx="56" cy="47" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
...
exports.SmallSoundSensorElement = SmallSoundSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-small-sound-sensor')
