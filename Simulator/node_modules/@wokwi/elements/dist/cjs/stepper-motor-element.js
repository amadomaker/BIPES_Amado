...
let StepperMotorElement = class StepperMotorElement extends lit_1.LitElement {
    ...
    get pinInfo() {
        ...
        const xOff = (spec.frameSize / 2 - 3.75) * units_1.mmToPix + 1;
        const yOff = (spec.frameSize + 5) * units_1.mmToPix;
        const pi = [
            { name: 'A-', y: yOff, x: xOff, number: 1, signals: [] },
            { name: 'A+', y: yOff, x: xOff + 2.54 * units_1.mmToPix, number: 2, signals: [] },
            { name: 'B+', y: yOff, x: xOff + 5.08 * units_1.mmToPix, number: 3, signals: [] },
            { name: 'B-', y: yOff, x: xOff + 7.62 * units_1.mmToPix, number: 4, signals: [] },
        ];
        return pi;
    }
    ...
    render() {
      ...
      version="1.1"
      viewBox="0 0 ${(1 + frameSize) * units_1.mmToPix} ${(5 + frameSize) * units_1.mmToPix}"
    ...
    >
      ...
      <g transform="translate(1,1)">
        <g transform="scale(${units_1.mmToPix})">
          <!-- Pins -->
          <path
            id="pin"
          ...
          <text font-family="arial" font-size="14.667px" text-align="center" text-anchor="middle">
            <tspan
              ...
              font-size="${spec.textSize / units_1.mmToPix}px"
            >
              ${this.value}
            </tspan>
            <tspan
              ...
              font-size="${(0.7 * spec.textSize) / units_1.mmToPix}px"
            >
              ${this.units}
            </tspan>
          </text>
...
exports.StepperMotorElement = StepperMotorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-stepper-motor')
], StepperMotorElement);
