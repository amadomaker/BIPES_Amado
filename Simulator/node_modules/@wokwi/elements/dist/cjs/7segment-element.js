      ...
      >
        <defs>
          <pattern id="pin-pattern" height="2" width="2.54" patternUnits="userSpaceOnUse">
            ${pins === 'extend'
            ? (0, lit_1.svg) `<rect x="1.02" y="0" height="2" width="0.5" fill="#aaa" />`
            : (0, lit_1.svg) `<circle cx="1.27" cy="1" r="0.5" fill="#aaa" />`}
          </pattern>
        </defs>
...
exports.SevenSegmentElement = SevenSegmentElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-7segment')
], SevenSegmentElement);
