...
let NeopixelMatrixElement = class NeopixelMatrixElement extends lit_1.LitElement {
    ...
    get pinInfo() {
        ...
        return [
            ...
            { name: 'VCC', x: cx - 0.5 * p, y, signals: [(0, pin_1.VCC)()] },
...
__decorate([
    (0, decorators_js_1.property)({ attribute: 'rowspacing' })
], NeopixelMatrixElement.prototype, "rowSpacing", void 0);
__decorate([
    (0, decorators_js_1.property)({ attribute: 'colspacing' })
...
exports.NeopixelMatrixElement = NeopixelMatrixElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-neopixel-matrix')
