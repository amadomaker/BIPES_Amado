...
const TOOLBAR_ICON_SVGS = {
  ...
  `,
  rotate: `
    <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#1f2937" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M17 7a7 7 0 1 0-6 11"/>
      <path d="M11 18H6l1.5-2.5Z" fill="#1f2937" stroke="#1f2937"/>
    </svg>
  `,
  flip: `
    <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#1f2937" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
      <path d="M6 6l3 6-3 6Z"/>
      <path d="M18 6l-3 6 3 6Z" fill="#1f2937" stroke="#1f2937"/>
      <path d="M12 4v16"/>
    </svg>
  `,
};
